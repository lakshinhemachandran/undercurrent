...
export default function HomePage() {
  return (
    <main className="mx-auto h-screen max-w-6xl px-4 pb-16 sm:px-6 lg:px-8 flex flex-col justify-between overflow-hidden">
      <div>
        <SiteHeader />
        <section className="grid gap-8 py-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:py-20">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-teal-300/20 bg-teal-300/10 px-4 py-2 text-sm text-teal-100">
              <Sparkles className="h-4 w-4" /> Private self-reflection for teens
            </div>
            ...
            <div className="space-y-5">
              ...
              {/* UNEED BADGE PLACED RIGHT UNDERNEATH THE SELF-REFLECTION DESCRIPTION */}
              <div className="pt-2">
                <a href="https://www.uneed.best/tool/undercurrent">
    <img src="https://www.uneed.best/EMBED3B.png" alt="Uneed Embed Badge" />
    </a>
              </div>
            </div>
          ...
          <div className="glass-card relative overflow-hidden rounded-[2rem] p-6">
            ...
            <div className="relative space-y-4">
              <div className="flex items-center gap-3 text-sm text-slate-300">
                <ShieldCheck className="h-5 w-5 text-teal-300" /> No diagnosis. No clinical label. Just reflection.
              </div>
      ...
      <footer className="mt-12 mb-0 text-center text-sm text-slate-500">
        Created by{" "}
        <Link href="https://github.com/lakshinhemachandran" target="_blank" rel="noopener noreferrer" className="text-slate-400 transition hover:text-teal-300 underline underline-offset-4" >
